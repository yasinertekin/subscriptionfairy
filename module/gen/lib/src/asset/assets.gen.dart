...
class $AssetsIconsGen {
  ...
  SvgGenImage get icGoogleLogo =>
      const SvgGenImage('assets/icons/ic_google_logo.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_cash.png
  AssetGenImage get imgCash =>
      const AssetGenImage('assets/images/img_cash.png');

  /// List of all assets
  List<AssetGenImage> get values => [imgCash];
}

class $AssetsLottieGen {
  const $AssetsLottieGen();

  /// File path: assets/lottie/lottie_explosion.json
  LottieGenImage get lottieExplosion =>
      const LottieGenImage('assets/lottie/lottie_explosion.json');
  ...
  /// File path: assets/lottie/lottie_welcome.json
  LottieGenImage get lottieWelcome =>
